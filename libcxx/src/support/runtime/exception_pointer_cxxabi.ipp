...
exception_ptr::~exception_ptr() noexcept { if (__ptr_) __cxa_decrement_exception_refcount(__ptr_); }
...
_LIBCPP_NORETURN void __attribute__((no_sanitize("thread"))) rethrow_exception(exception_ptr p) {
