...
set(LLVM_RELEASE_ENABLE_BOLTOPT ON CACHE BOOL "")
...
if(LLVM_RELEASE_ENABLE_LINK_LOCAL_RUNTIMES)
  ...
  set(LLVM_RELEASE_STATIC_LINK_CXX_STDLIB "ON" CACHE BOOL "Statically link the C++ standard library in release bootstrap stages")
  set_instrument_and_final_stage_var(LLVM_STATIC_LINK_CXX_STDLIB "${LLVM_RELEASE_STATIC_LINK_CXX_STDLIB}" BOOL)
...
if (${CMAKE_HOST_SYSTEM_NAME} MATCHES "Linux" AND LLVM_RELEASE_ENABLE_BOLTOPT)
