...
static void handleInstrumentNonCoroutineFunctionEnterAttr(Sema &S, Decl *D,
                                                          const ParsedAttr &AL) {
  StringRef Str;
  SourceLocation LiteralLoc;
  if (!S.checkStringLiteralArgumentAttr(AL, 0, Str, &LiteralLoc))
  ...
  InstrumentNonCoroutineFunctionEnterAttr *NewAttr =
      ::new (S.Context) InstrumentNonCoroutineFunctionEnterAttr(S.Context, AL,
                                                                Str);
  D->addAttr(NewAttr);
}
...
ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D, const ParsedAttr &AL,
  ...
  case ParsedAttr::AT_InstrumentNonCoroutineFunctionEnterDisable:
    handleSimpleAttribute<InstrumentNonCoroutineFunctionEnterDisableAttr>(S, D,
                                                                         AL);
    break;
