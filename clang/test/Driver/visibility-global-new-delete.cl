...
// RUN:   -fvisibility-global-new-delete-hidden %s 2>&1 | FileCheck -check-prefixes=VGNDH %s %{implicit-check-nots}
...
// RUN:     FileCheck -check-prefixes=VGNDH %s %{implicit-check-nots}
...
// RUN:     FileCheck -check-prefixes=VGNDP %s %{implicit-check-nots}
