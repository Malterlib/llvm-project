...
class ChunkHeader {
 public:
  ...
  // Used to report the original size (0) to the user via usable size APIs.
...
uptr asan_malloc_usable_size(const void *ptr, uptr pc, uptr bp) {
  ...
  // standard. Usable size APIs should still report the originally requested
  // size (0), because the upgraded byte remains poisoned.
  if (usable_size > 0 &&
