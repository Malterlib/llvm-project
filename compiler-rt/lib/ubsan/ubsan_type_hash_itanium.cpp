...
const abi::__si_class_type_info *
__overidable_ubsan_get_dyncast_si(const abi::__class_type_info *Ptr) {
  return dynamic_cast<const abi::__si_class_type_info *>(Ptr);
}

SANITIZER_INTERFACE_ATTRIBUTE SANITIZER_WEAK_ATTRIBUTE
const abi::__vmi_class_type_info *
__overidable_ubsan_get_dyncast_wmi(const abi::__class_type_info *Ptr) {
  return dynamic_cast<const abi::__vmi_class_type_info *>(Ptr);
}

SANITIZER_INTERFACE_ATTRIBUTE SANITIZER_WEAK_ATTRIBUTE abi::__class_type_info *
__overidable_ubsan_get_dyncast_class(std::type_info *Ptr) {
