...
const __cxxabiv1::__si_class_type_info *
__overidable_ubsan_get_dyncast_si(const __cxxabiv1::__class_type_info *Ptr) {
    return dynamic_cast<const __cxxabiv1::__si_class_type_info *>(Ptr);
}

__attribute__((no_sanitize("undefined"))) __attribute__((used)) __attribute__((__visibility__("default")))
const __cxxabiv1::__vmi_class_type_info *
__overidable_ubsan_get_dyncast_wmi(const __cxxabiv1::__class_type_info *Ptr) {
