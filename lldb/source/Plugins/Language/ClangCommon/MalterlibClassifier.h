...
public:
  ...
  HighlightStyle::ColorStyle highlightString(llvm::StringRef identifier,HighlightStyle::ColorStyle default_style) const;
  HighlightStyle::ColorStyle highlightPunctuation(llvm::StringRef identifier, HighlightStyle::ColorStyle default_style) const;
  HighlightStyle::ColorStyle highlightKeyword(llvm::StringRef identifier, HighlightStyle::ColorStyle default_style) const;
  HighlightStyle::ColorStyle highlightComment(llvm::StringRef identifier, HighlightStyle::ColorStyle default_style) const;
};
