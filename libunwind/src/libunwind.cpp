...
__attribute__((no_sanitize("thread"))) _LIBUNWIND_HIDDEN int
__unw_resume_with_frames_walked(unw_cursor_t *cursor, unsigned walkedFrames) {
...
__attribute__((no_sanitize("thread"))) _LIBUNWIND_HIDDEN int
__unw_resume(unw_cursor_t *cursor) {
